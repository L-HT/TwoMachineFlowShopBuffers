...
#' @export
getIdleTimeR <- function(jobData, permutationM1, permutationM2, maxBufferSize){
  m1 <- Machine$new()
  m2 <- Machine$new()
  m1$name <- "m1"
  m2$name <- "m2"
...
#' @export
getIdleTimeTotalBufferR <- function(jobData, permutationM1, permutationM2, maxBufferSize){
  m1 <- Machine$new()
  m2 <- Machine$new()
  m1$name <- "m1"
  m2$name <- "m2"
  ...
  # print("ende")
  # print("result")
  return(result)#sum(buffer$bufferUsage))
}
